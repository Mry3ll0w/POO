...
void Fecha::Fecha_check(int dd, int mm, int yy)
{
    ...
    else
    {
        ...
        {
            throw Fecha::Invalida("este mes no tiene 31 dias");
        }
        else if ((mm == 2 && ((yy % 4) != 0)) && (dd > 28))
        {
            throw Fecha::Invalida("Este anno no es bisiesto");
        }
        else if (mm == 2 && dd > 29)
            throw Fecha::Invalida("feb no tiene mas de 29 dias");
    }
}
